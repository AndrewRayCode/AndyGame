...
class BannerManager {
    ...
    /// Show a congratulations banner (special case for square breaking)
    func showCongratulationsBanner() {
        guard let parentView = parentView else { return }
        ...
        NSLayoutConstraint.activate([
            ...
            banner.bottomAnchor.constraint(equalTo: parentView.safeAreaLayoutGuide.bottomAnchor, constant: 20),
            banner.widthAnchor.constraint(lessThanOrEqualTo: parentView.widthAnchor, multiplier: 0.8),
            banner.heightAnchor.constraint(equalToConstant: 50),
